...
<view class="box" style="padding: 20rpx;">
  <view class="header" style="display: flex; justify-content: space-between;">
    ...
    <view style="display: flex; justify-content: flex-start;" bind:tap="contact">
      <button style="background-color: #FF7101; width: 200rpx; height: 100rpx; color: #F4E4CD; font-size: 30rpx; line-height: 60rpx; border-radius: 0;">联系Ta</button>
  ...
  <view class="images">
    <image wx:for="{{goods_image}}" wx:key="*this" src="{{item}}" mode="" style="display: block; margin-top: 30rpx; width: 600rpx;"/>
  </view>
</view>
```
